...
export const PersonalInfoCard: React.FC<PersonalInfoCardProps> = ({ personal }) => {
  return (
    <Card withBorder padding="lg" h="100%">
      <Group mb="md">
        ...
        <Title order={3} size="h4">Información Personal</Title>
      </Group>
        ...
        <Stack gap="md">
          {personal.gender && (
            <Group justify="space-between">
              ...
              <Badge variant="outline" size="sm">{personal.gender}</Badge>
            </Group>
          )}
          
          {personal.marital_status && (
            <Group justify="space-between">
              <Text size="sm" c="dimmed">Estado Civil</Text>
          ...
          {personal.education_level && (
            <Group justify="space-between">
              <Text size="sm" c="dimmed">Nivel de Educación</Text>
          ...
          {personal.occupation && (
            <Group justify="space-between">
              <Text size="sm" c="dimmed">Ocupación</Text>

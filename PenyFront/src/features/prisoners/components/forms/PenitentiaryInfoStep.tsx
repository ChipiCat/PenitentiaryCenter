...
export const PenitentiaryInfoStep: React.FC<PenitentiaryInfoStepProps> = ({ 
  ...
  // Handler para datos penitenciarios
  const handlePenitentiaryChange = (field: string, value: any) => {
    onUpdate({
      penitentiary: {
        ...data.penitentiary,
        [field]: value
    ...
    <Stack gap="lg">
      <Card withBorder padding="lg">
        ...
        <Text size="sm" c="dimmed" mb="lg">
          Información sobre la ubicación y categoría del prisionero dentro del centro
        </Text>
        ...
        <Stack gap="md">
          <Select
            ...
            onChange={(value) => handlePenitentiaryChange('category', value)}
            data={[
          ...
          <Group grow>
            <TextInput
              ...
              onChange={(e) => handlePenitentiaryChange('building_number', e.target.value)}
            ...
            <TextInput
              ...
              onChange={(e) => handlePenitentiaryChange('cell_number', e.target.value)}
          ...
          <TextInput
            ...
            onChange={(e) => handlePenitentiaryChange('bed_number', e.target.value)}
